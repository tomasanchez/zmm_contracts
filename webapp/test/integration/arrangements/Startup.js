sap.ui.define([
	"sap/ui/test/Opa5",
	"pampa/comunicacionesformales/contratos/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("pampa.comunicacionesformales.contratos.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "pampa.comunicacionesformales.contratos",
					async: true
				},
				hash: oOptions.hash,
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			this.waitFor({
				success : function() {
					oOptions.hash = "Material_ListSet/" + sObjectId;
