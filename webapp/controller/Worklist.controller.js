    ...
    return BaseController.extend(
      "pampa.comunicacionesformales.contratos.controller.Worklist",
      {
        ...
        onCloseContract: function (oEvent) {
          let oBinding = oEvent.getSource().getParent().getBindingContext();
          MessageBox.confirm(
            this.readFromI18n("WorklistView.ConfirmCloseContract"),
            {
              onClose: function (sAction) {
                sAction == sap.m.MessageBox.Action.OK &&
                  this._updateObject(oBinding.getPath(), oBinding.getObject());
              }.bind(this),
            }
          );
        },
